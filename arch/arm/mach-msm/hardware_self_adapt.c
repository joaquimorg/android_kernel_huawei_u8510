	 ...
	 if( machine_is_msm7x27_m865()||machine_is_msm7x27_u8650()||machine_is_msm7x27_c8650() || machine_is_msm7x27_c8651())
	 {
		 switch (lcd_id)
		 {
			 ...
			 case 2:  
				 ...
				 break;
			 case 3:
				 hw_lcd_panel = LCD_ILI9486_TIANMA_HVGA;
				 break;
			 case 4:
				 hw_lcd_panel = LCD_ILI9486_CHIMEI_HVGA;
				 break;
			 case 5:
				 hw_lcd_panel = LCD_HX8357B_CHIMEI_HVGA;
				 break;
			 default : 
				 hw_lcd_panel = LCD_S6D74A0_SAMSUNG_HVGA;
				 break; 
  ...
  if(machine_is_msm7x27_u8650() || machine_is_msm7x27_m865() || machine_is_msm7x27_c8650() || machine_is_msm7x27_c8651())
    {               
        ...
        if ((hw_lcd_panel == LCD_ILI9481DS_TIANMA_HVGA) ||(hw_lcd_panel == LCD_ILI9481D_INNOLUX_HVGA)
			|| (hw_lcd_panel == LCD_ILI9486_TIANMA_HVGA) || (hw_lcd_panel == LCD_ILI9486_CHIMEI_HVGA)
			|| (hw_lcd_panel == LCD_HX8357B_CHIMEI_HVGA))
        {
...
char *get_lcd_panel_name(void)
{
	 ...
	 switch (hw_lcd_panel)
	 {
		...
		case LCD_ILI9486_TIANMA_HVGA:
			pname = "TIANMA ILI9486";
			break ;
		case LCD_ILI9486_CHIMEI_HVGA:
			pname = "CHIMEI ILI9486";
			break ;
		case LCD_HX8357B_CHIMEI_HVGA:
            pname = "CHIMEI HX8357B";
            break;
		 default:
			 pname = "UNKNOWN LCD";
			 break;
