...
#ifdef CONFIG_HUAWEI_KERNEL
	ret = 0;
    lcdtype = lcd_panel_probe();
	if( (LCD_HX8368A_SEIKO_QVGA != lcdtype ) && 
        (LCD_R61529_TRULY_HVGA != lcdtype ) && 
        (LCD_S6D74A0_SAMSUNG_HVGA != lcdtype )&&
        (LCD_ILI9486_TIANMA_HVGA != lcdtype)&&
        (LCD_ILI9486_CHIMEI_HVGA != lcdtype)&&
        (LCD_HX8357B_CHIMEI_HVGA != lcdtype))
	{
